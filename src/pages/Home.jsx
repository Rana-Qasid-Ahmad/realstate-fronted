      ...
      <section className="relative min-h-[85vh] flex items-center" style={{ background: 'linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)' }}>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full">
          <div className="max-w-3xl mb-12">
            <span className="inline-block bg-white text-primary-400 text-sm font-medium px-4 py-2 rounded-full mb-6 border border-primary-500/30">🏆 Pakistan's #1 Real Estate Platform</span>
